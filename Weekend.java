public class Weekend implements Important {
    ...
    @Override
    public void addDetails(String Sname, String Saddress, char Ssex, int Sborn_year, String Sspecialization, String Sjob_title) {
        name = Sname;
        address = Saddress;
        sex = Ssex;
    ...
    public void showDetails() {
        ...
        System.out.println("Student Job : " + job_title);
    }
